...
Packed with [dvdoug/boxpacker](https://github.com/dvdoug/boxpacker) 4.3 on PHP 8.4. No box supply limits; quantities are tuned so the bulk fills 3 Trunks and the remainder drops into a smaller box.
