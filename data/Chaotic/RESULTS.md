...
Packed with [dvdoug/boxpacker](https://github.com/dvdoug/boxpacker) 4.3 on PHP 8.4. Runtime ~0.2s. Items with no BoxGroup can share a box with any group, so they pack in the same pass as the largest group (CORROSIVE); FOOD packs separately. This dataset deliberately contains awkward shapes and supply limits.
